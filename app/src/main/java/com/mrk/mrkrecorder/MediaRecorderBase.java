...
import com.mrk.mrkrecorder.jniinterface.FFmpegBridge;
...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
    ...
    protected void prepareCameraParaments() {
        ...
        if (!findWidth) {
            Log.e("mrk", "传入高度不支持或未找到对应宽度,请按照要求重新设置，否则会出现一些严重问题");
    ...
    public void startPreview() {
        ...
        try {
            ...
            try {
                ...
                Log.e("mrk", "setPreviewDisplay Exception: " + e.getMessage());
            }
            ...
            Log.e("mrk", "startPreview Exception: " + e.getMessage());
        }
    }
...
//                camera.addCallbackBuffer(new byte[buffSize]);
                ...
                Log.e("mrk", "startPreview...setPreviewCallback...", e);
            }
            Log.e("mrk", "startPreview...setPreviewCallbackWithBuffer...width: " + size.width + " height: " + size.height);
        } else {
    ...
    public void stopPreview() {
        if (camera != null) {
            try {
                ...
                Log.e("mrk", "stopPreview..." + e.getMessage());
            }
            camera = null;
        }
